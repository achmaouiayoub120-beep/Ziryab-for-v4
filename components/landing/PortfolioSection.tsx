...
/* ══════════════════════════════════════════════════════════
   PortfolioSection — Section Home avec 3 projets professionnels
   ══════════════════════════════════════════════════════════ */
...
export default function PortfolioSection() {
  ...
  return (
    <SectionWrapper id="portfolio-section" className="py-24 bg-[var(--bg-alt)]">
      ...
      <motion.div
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[1200px] mx-auto"
            ...
            <div className="p-6 flex flex-col flex-1">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                {project.technologies.length > 4 && (
                  <span className="px-2 py-0.5 rounded bg-[var(--bg-alt)] text-[10px] font-bold text-[var(--text-muted)] border border-[var(--border)]">
                    +{project.technologies.length - 4}
                  </span>
                )}
              </div>
